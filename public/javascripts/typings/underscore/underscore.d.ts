...
interface UnderscoreStatic {
     ...
     * @see _.map
     **/
    collect<T, TResult>(list:_.List<T>,
                        iterator:_.ListIterator<T, TResult>,
                        context?:any): TResult[];
     ...
     * @see _.map
     **/
    collect<T, TResult>(object:_.Dictionary<T>,
                        iterator:_.ObjectIterator<T, TResult>,
                        context?:any): TResult[];
     ...
     **/
    reduce<T, TResult>(list:_.Collection<T>,
     ...
     * @see _.reduce
     **/
    inject<T, TResult>(list:_.Collection<T>,
                       iterator:_.MemoIterator<T, TResult>,
                       memo?:TResult,
                       context?:any): TResult;
